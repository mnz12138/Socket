...
+ (instancetype)share {
    ...
    static SocketRocketManager *instance = nil;
...
- (void)initSocketIp:(NSString *)server_ip port:(unsigned short)server_port {
    ...
    webSocket = [[SRWebSocket alloc]initWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"ws://%@:%d", server_ip, server_port]]];
